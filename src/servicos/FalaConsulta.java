...
public class FalaConsulta extends ModuloTelemedicina {
    ...
    public void executar(Scanner scanner) {
        ...
        switch (opcaoQueixa) {
            case 1: localProblema = "Braço"; break;
            case 2: localProblema = "Perna"; break;
            case 3: localProblema = "Abdômen"; break;
            case 4: localProblema = "Cabeça"; break;
            case 5:
            default:
        ...
        String tipoProblema = "";
        switch (opcaoTipo) {
            case 1: tipoProblema = "Queimadura"; break;
            case 2: tipoProblema = "Dor"; break;
            case 3: tipoProblema = "Inchaço"; break;
            case 4:
            default:
        ...
        // NOVA PARTE: integração com comando de voz
        System.out.println("\nCaio: Agora você pode usar comandos de voz.");
        System.out.println("Diga algo como 'iniciar consulta' ou 'encerrar consulta'.");
        System.out.print("Comando: ");
        String comandoVoz = scanner.nextLine();
        simularComandoVoz(comandoVoz);
    }

    // Novo método para simular comandos de voz
    public void simularComandoVoz(String comando) {
        if (comando == null || comando.isEmpty()) {
            System.out.println("Caio: Não entendi o comando. Por favor, repita.");
            return;
        }
        ...
        switch (comando) {
            case "iniciar consulta":
                System.out.println("Caio: Iniciando consulta com o médico...");
                break;
            case "encerrar consulta":
                System.out.println("Caio: Encerrando consulta. Espero que tenha um ótimo dia!");
                break;
            default:
                System.out.println("Caio: Comando de voz não reconhecido: \"" + comando + "\"");
                System.out.println("Caio: Tente dizer 'iniciar consulta' ou 'encerrar consulta'.");
                break;
        }
    }
}
